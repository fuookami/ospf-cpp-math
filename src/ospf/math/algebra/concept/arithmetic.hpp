...
namespace ospf
{
    inline namespace math
    {
        inline namespace algebra
        {
            ...
            {
                inline static constexpr const i16 zero(void) noexcept { return 0_i16; }
                inline static constexpr const i16 one(void) noexcept { return 1_i16; }
            };

            template<>
            struct ArithmeticTrait<u16>
            {
                inline static constexpr const u16 zero(void) noexcept { return 0_u16; }
                inline static constexpr const u16 one(void) noexcept { return 1_u16; }
            };
            ...
            {
                inline static constexpr const u32 zero(void) noexcept { return 0_u32; }
                inline static constexpr const u32 one(void) noexcept { return 1_u32; }
            };

            template<>
            struct ArithmeticTrait<i64>
            {
                inline static constexpr const i64 zero(void) noexcept { return 0_i64; }
                inline static constexpr const i64 one(void) noexcept { return 1_i64; }
            };

            template<>
            struct ArithmeticTrait<u64>
            {
                inline static constexpr const u64 zero(void) noexcept { return 0_u64; }
                inline static constexpr const u64 one(void) noexcept { return 1_u64; }
            };

            template<>
            struct ArithmeticTrait<i128>
            {
                inline static constexpr const i128 zero(void) noexcept { return i128{ 0_i64 }; }
                inline static constexpr const i128 one(void) noexcept { return i128{ 1_i64 }; }
            };

            template<>
            struct ArithmeticTrait<u128>
            {
                inline static constexpr const u128 zero(void) noexcept { return u128{ 0_u64 }; }
                inline static constexpr const u128 one(void) noexcept { return u128{ 1_u64 }; }
            };

            template<>
            struct ArithmeticTrait<i256>
            {
                inline static constexpr const i256 zero(void) noexcept { return i256{ 0_i64 }; }
                inline static constexpr const i256 one(void) noexcept { return i256{ 1_i64 }; }
            };

            template<>
            struct ArithmeticTrait<u256>
            {
                inline static constexpr const u256 zero(void) noexcept { return u256{ 0_u64 }; }
                inline static constexpr const u256 one(void) noexcept { return u256{ 1_u64 }; }
            };

            template<>
            struct ArithmeticTrait<i512>
            {
                inline static constexpr const i512 zero(void) noexcept { return i512{ 0_i64 }; }
                inline static constexpr const i512 one(void) noexcept { return i512{ 1_i64 }; }
            };

            template<>
            struct ArithmeticTrait<u512>
            {
                inline static constexpr const u512 zero(void) noexcept { return u512{ 0_u64 }; }
                inline static constexpr const u512 one(void) noexcept { return u512{ 1_u64 }; }
            };

            template<>
            struct ArithmeticTrait<i1024>
            {
                inline static constexpr const i1024 zero(void) noexcept { return i1024{ 0_i64 }; }
                inline static constexpr const i1024 one(void) noexcept { return i1024{ 1_i64 }; }
            };

            template<>
            struct ArithmeticTrait<u1024>
            {
                inline static constexpr const u1024 zero(void) noexcept { return u1024{ 0_u64 }; }

        ...
        inline namespace algebra
        {
            inline namespace comparison_operator
            {
                namespace less_equal
                {
                    ...
                    public:
                        constexpr LessEqualSignedImpreciseImpl(CLRefType<ValueType> precision = PrecisionTrait<ValueType>::decimal_precision)
                            : _precision(precision) {}

                        template<typename = void>
                            requires ReferenceFaster<ValueType> && std::movable<ValueType>
                        LessEqualSignedImpreciseImpl(RRefType<ValueType> precision)
                            : _precision(precision) {}
                    ...
                    public:
                        constexpr LessEqualUnsignedImpreciseImpl(CLRefType<ValueType> precision = PrecisionTrait<ValueType>::decimal_precision)
                            : _precision(precision) {}

                        template<typename = void>
                            requires ReferenceFaster<ValueType> && std::movable<ValueType>
                        LessEqualUnsignedImpreciseImpl(RRefType<ValueType> precision)
                ...
                public:
                    ...
                    constexpr LessEqual(CLRefType<ValueType> precision = ArithmeticTrait<ValueType>::zero)
                        : _impl(impl(precision)) {}

                    template<typename = void>
                        requires WithPrecision<ValueType>
                    constexpr LessEqual(CLRefType<ValueType> precision = PrecisionTrait<ValueType>::decimal_precision)
                        : _impl(impl(precision)) {}

                    template<typename = void>
                        requires ReferenceFaster<ValueType>&& std::movable<ValueType>
                    LessEqual(RRefType<ValueType> precision)
                ...
                public:
                    ...
                    constexpr LessEqual(CLRefType<ValueType> _) = default;
